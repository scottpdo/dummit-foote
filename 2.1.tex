...
Clearly $SL_n(F)$ is a subset of $GL_n(F)$, since by definition $A \in SL_n(F) \Rightarrow GL_n(F)$. It remains to be proven that $SL_n(F)$ is a subgroup, which we will show by the subgroup criterion.
